        ...
        @endphp
                ...
                <div class="flex flex-col lg:flex-row pb-10 md:pb-16">
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-5 lg:w-7/12 lg:mt-0 lg:ml-12">
                        {{-- <a href="" class="underline font-bold text-slate-900 text-lg">Catégorie {{ $post->discipline }}</a> --}}
                        ...
                        <a href="{{ route($disciplineName) }}" class="flex items-center py-2 px-7 font-semibold bg-blue-900 transition text-slate-50 rounded-full">
