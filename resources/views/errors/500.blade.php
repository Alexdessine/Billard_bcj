...
<x-layout>
    ...
    <section>
        <x-title>Erreur interne du serveur</x-title>

        <x-cadre>
            <div class="text-center py-12 space-y-6 error">
                <i class="fa-solid fa-triangle-exclamation text-6xl text-blue-600" aria-hidden="true"></i>
...
<style>
    .error{ margin:auto; }
    i.fa-triangle-exclamation{ display:inline-block; font-size:30px; color:rgb(37,99,235); margin:20px 0; }
</style>
