...
<x-layout>
    ...
    <section>
        <x-title>Maintenance en cours</x-title>

        <x-cadre>
            <div class="text-center py-12 space-y-6 error">
                <i class="fa-solid fa-screwdriver-wrench text-6xl text-blue-600" aria-hidden="true"></i>

                <p class="text-gray-600">
                    Le site est momentanément indisponible. Nous revenons très vite !
                </p>
...
<style>
    .error{ margin:auto; }
    i.fa-screwdriver-wrench{ display:inline-block; font-size:30px; color:rgb(37,99,235); margin:20px 0; }
</style>
