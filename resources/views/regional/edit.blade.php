            ...
            <form method="POST" action="{{ route('regional.update', $regional->id) }}">
                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="mt-10 ml-10 mr-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="name" id="name" autocomplete="nom du tournoi" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ $regional->titre }}">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="club" id="club" autocomplete="club organisateur" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ $regional->club }}">
                                </div>
                            </div>
                        ...
                        <div class="mt-2">
                            <input type="date" name="date-fin" id="date-fin" autocomplete="fin du tournoi" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ $regional->date_fin }}">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="url" name="url" id="url" autocomplete="https" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ $regional->url }}">
                        </div>
                    </div>
                </div>

                <div class="mt-6 ml-10 mr-10 flex items-center justify-end gap-x-6">
                    <a href="{{ route('regional') }}"  class="p-1.5 px-3 rounded-md bg-green-600 text-sm font-semibold leading-6 text-white">Annuler</a>
