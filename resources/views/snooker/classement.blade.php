<x-layout>
    ...
    <section>
        ...
        <div class="classement">
            <x-cadre>
        @foreach ($snookerData as $categorie => $participants)
        ...
        @endforeach
                <div class="classement-complet">
                    <a class="btn btn-success" href="{{ $snookerClassement->url }}{{ $snookerClassement->mixte }}" target="_blank">Voir les classements complets</a>
                </div>
