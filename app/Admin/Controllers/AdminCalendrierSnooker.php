...
class AdminCalendrierSnooker extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Calendrier Snooker';
    ...
    {
        $grid = new Grid(new CalendrierSnooker());
    ...
    {
        $show = new Show(CalendrierSnooker::findOrFail($id));
    ...
    {
        $form = new Form(new CalendrierSnooker());
