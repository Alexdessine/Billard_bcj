...
class AdminAmericainCalendrierInternational extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Calendrier international - Discipline américain';
    ...
    {
        $grid = new Grid(new AmericainCalendrierInternational());
        ...
        $grid->column('actions', __('Liens'))->display(function () {
            $linkExists = \App\Models\AmericainInternationalLink::where('calendrier_id', $this->id)->exists();

            if ($linkExists) {
                return '<a href="/admin/americain/liens_cuescore/international-links?calendrier_id=' . $this->id . '" class="btn btn-sm btn-primary">Voir les liens Cuescore</a>';
            } else {
                return '<a href="/admin/americain/liens_cuescore/international-links/create?calendrier_id=' . $this->id . '" class="btn btn-sm btn-warning">Ajouter les liens Cuescore</a>';
            }
        });
    ...
    {
        $show = new Show(AmericainCalendrierInternational::findOrFail($id));
    ...
    {
        $form = new Form(new AmericainCalendrierInternational());
